...
@Route(RouterUtil.ROUTER_PRICE_LOCAL_A)
public class PriceListAFragment extends BaseFragment implements PriceListAContract.View {

    @BindView(R.id.price_local_list)
    SuperListview mList;

    PriceListAContract.Presenter mPresenter;

    private int mPage;
    private int mTotalSize;

    @Override
    public void setPresenter(PriceListAContract.Presenter presenter) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mPresenter = new PriceListAPresentImpl(this);

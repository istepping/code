...
@Route(RouterUtil.ROUTER_PRICE_LOCAL_C)
public class PriceListCFragment extends BaseFragment implements PriceListCContract.View {

    @BindView(R.id.price_local_list)
    SuperListview mList;

    PriceListCContract.Presenter mPresenter;

    private int mPage;
    private int mTotalSize;

    @Override
    public void setPresenter(PriceListCContract.Presenter presenter) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mPresenter = new PriceListCPresentImpl(this);

...
@Route(RouterUtil.ROUTER_PUBLISH_STREAM_STOP)
public class PublishStreamStopFragment extends BaseFragment implements PublishStreamStopContract.View {

    @BindView(R.id.publish_stream_list)
    SuperListview mList;

    PublishStreamStopContract.Presenter mPresenter;

    private int mPage;
    private int mTotalSize;

    @Override
    public void setPresenter(PublishStreamStopContract.Presenter presenter) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mPresenter = new PublishStreamStopPresentImpl(getContext(), this);
    ...
    public void showList(PublishStreamList publishStreamList) {
        ...
        if (mPage == 1) {
            ...
            mList.setAdapter(new PublishStreamAdapter(getContext(), 2, null, null, mPresenter, publishStreamList.getResultData()));
    ...
    public void onPublishStreamStopEvent(PublishStreamStopEvent publishStreamStopEvent) {

...
@Route(RouterUtil.ROUTER_PRICE_LOCAL_D)
public class PriceListDFragment extends BaseFragment implements PriceListDContract.View {

    @BindView(R.id.price_local_list)
    SuperListview mList;

    PriceListDContract.Presenter mPresenter;

    private int mPage;
    private int mTotalSize;

    @Override
    public void setPresenter(PriceListDContract.Presenter presenter) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mPresenter = new PriceListDPresentImpl(this);
